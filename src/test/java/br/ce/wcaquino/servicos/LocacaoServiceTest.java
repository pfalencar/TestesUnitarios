...
//		assertThat(locacao.getValor(), is(not(6.0)));
	...
	@Test
	public void devePagar0PorCentoNoFilme6() throws Exception {				
		//cenário
		Usuario usuario = new Usuario("Patricia");		
		List<Filme> filmes = Arrays.asList(
				new Filme("Jurassic Park", 2, 5.00), 
				new Filme("O poderoso chefinho II", 2, 8.00),
				new Filme("O Segredo", 3, 4.00), 
				new Filme("A Praia", 7, 6.00), 
				new Filme("Jackie Chan", 1, 3.00),
				new Filme("A coisa", 4, 4.00)
				);
		...
		//verificação
		error.checkThat(locacao.getValor(), is(equalTo(19.75)));			
	}
